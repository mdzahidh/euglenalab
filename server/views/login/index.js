'use strict';
var autoMuseum={
  username:{name:'dirk_joystick', code:'40541d0ddd8c'},
  password:{name:'0afec0', code:'c408cd5baa69'},
};
...
exports.init = function(req, res){
  ...
  var str=req.url+'';
  if(str.length>7) {
    autologin=str.substr(7, str.length);
    var museumCode=autoMuseum.username.code+autoMuseum.password.code;
    if(autologin===museumCode) {
      autologin=museumCode;
    }
  }
...
exports.login = function(req, res){
  ...
  if(req.body.autologin && req.body.autologin.length>0) {
    if(autoMuseum.username.code===req.body.username) {
      req.body.username=autoMuseum.username.name;
    }
    if(autoMuseum.password.code===req.body.password) {
      req.body.password=autoMuseum.password.name;
    }
  }
