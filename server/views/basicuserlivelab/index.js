...
exports.init = function(req, res, next) {
  ...
  var setupDiv=function(callback) {
    _setupDiv(null, function(err, divInfo, renderJade) {
...
var _setupDiv = function(username, callback) {
  var renderJade='basicuserlivelab/index';
  var divInfo={
    mainRowWidth:'75%',
    mainRowHeight:'480px',
  ...
  if(username && username==='dirk_joystick') {
    renderJade='basicuserlivelab/indexMuseum';
    divInfo={
